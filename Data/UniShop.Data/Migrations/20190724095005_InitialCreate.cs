        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UniShopUserId = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Addresses_AspNetUsers_UniShopUserId",
                        column: x => x.UniShopUserId,
            ...
            migrationBuilder.CreateTable(
                name: "UniShopFavoriteProducts",
                columns: table => new
                {
                    UniShopUserId = table.Column<string>(nullable: false),
                    ProductId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UniShopFavoriteProducts", x => new { x.ProductId, x.UniShopUserId });
                    table.ForeignKey(
                        name: "FK_UniShopFavoriteProducts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UniShopFavoriteProducts_AspNetUsers_UniShopUserId",
                        column: x => x.UniShopUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_UniShopUserId",
                        column: x => x.UniShopUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Addresses_UniShopUserId",
                table: "Addresses",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UniShopFavoriteProducts_UniShopUserId",
                table: "UniShopFavoriteProducts",
                column: "UniShopUserId");
        }
